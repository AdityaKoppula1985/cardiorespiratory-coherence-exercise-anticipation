...
#define nrn_init _nrn_init__hhx
#define _nrn_initial _nrn_initial__hhx
#define nrn_cur _nrn_cur__hhx
#define _nrn_current _nrn_current__hhx
#define nrn_jacob _nrn_jacob__hhx
#define nrn_state _nrn_state__hhx
#define _net_receive _net_receive__hhx 
#define _f_rates _f_rates__hhx 
#define rates rates__hhx 
#define states states__hhx 
...
#define _gth 0
#define htau_hhx _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_hhx _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_hhx _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_hhx _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_hhx _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_hhx _thread1data[5]
...
#if NMODL_TEXT
static const char* nmodl_filename = "hhx.mod";
static const char* nmodl_file_text = 
  "TITLE hhx.mod   squid sodium, potassium, and leak channels\n"
  " \n"
  ":COMMENT\n"
